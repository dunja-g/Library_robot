...
class NavigationConfig:
    ...
    aruco_approach_extra_cm: float = 3.0
    return_backout_reduction_cm: float = 10.0
    ...
    def __post_init__(self):
        ...
        if self.return_backout_reduction_cm < 0:
            raise ValueError("return_backout_reduction_cm must be non-negative")
    ...
    def from_env(cls) -> "NavigationConfig":
        ...
        return cls(
            ...
            aruco_approach_extra_cm=_env_number(
                "LIBRARY_ROBOT_ARUCO_APPROACH_EXTRA_CM", 3.0, float
            ),
            return_backout_reduction_cm=_env_number(
                "LIBRARY_ROBOT_RETURN_BACKOUT_REDUCTION_CM", 10.0, float
            ),
