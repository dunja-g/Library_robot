...
class NavigationConfig:
    ...
    aruco_approach_extra_cm: float = 0.0
    return_backout_reduction_cm: float = 3.0
    ...
    def from_env(cls) -> "NavigationConfig":
        ...
        return cls(
            ...
            aruco_approach_extra_cm=_env_number(
                "LIBRARY_ROBOT_ARUCO_APPROACH_EXTRA_CM", 0.0, float
            ),
            return_backout_reduction_cm=_env_number(
                "LIBRARY_ROBOT_RETURN_BACKOUT_REDUCTION_CM", 3.0, float
            ),
